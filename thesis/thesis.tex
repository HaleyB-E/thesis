...
\todo{maybe move conclusions to end, do more stuff with conclusions}
...
I. It's more possible to link rhetorical changes in US to various administrations
	-clinton and before: hostile rhetoric, subverted by back-channel negotiations (obviously that was intentional at least to some extent - desire for progress without facing public distaste for compromise?)
	-when bush happens, new focus on being the world's policeman, and "the right people" having nukes - fed into new harshening of "rogue state" concept, forcing US negotiations into all-or-nothing ultimata. also weakening of nonproliferation norms and shift to multilateral negotiations instead of direct contact
	-obama: even larger focus on multilateral, though some bilateral engagement also occurs - possibly less about "we don't negotiate with terrorists" and more "international norms-building" given renewed focus on non-proliferation norms; "strategic patience" and less ultimatum-y things
II. In general, major official position in government is informed heavily by "rogue state" concept - emphasizes hard requirements before negotiations.
	-but back-channel negotiations or individual officials willing to make more compromise
	-this is probably because presidents need to answer to a populace that is unhappy at the notion of diplomacy with the kim family
III. Verbal stance seems largely unaffected by DPRK behavior
	-similar admonishments for every provocation, return to call ofr sanctions, same level of outrage
	-evolution more heavily tied to ideological or practical priorities of the administration
	-moments of extreme outrage or maximal diplomacy work because of DPRK actions, but aren't solely opportunistic
