...
Here have an outline

\subsection{General Rhetorical Trends}
\subsubsection{DPRK}
kcna analysis: why focus on this? (most direct pipeline, free of translation with western agenda, western media spin, etc)

R\&S findings - general trends
...
\subsubsection{US}
Bleiker's notes: 'rogue state' language, administration-specific but also overall

anything of note that appears later and seems to belong here

\subsection{Cycle-differentiated analysis}
\subsubsection{What's going on}
we're reframing DPRK stuff to our time windows and doing US analysis

\subsubsection{DPRK}
Whatever happens when we reframe rich14, what we see from rich12, whatever falls out of Sin
