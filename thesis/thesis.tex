...
\todo{'technical analysis methodology'}
B. Analysis of access and materials capacity
Section will look at how much material we know NK has, how much we suspect has entered/exited due to smuggling and trade, what's been used up in missile tests, and what remains for nukes
Additionally, reprocessing capaity, missile tch, and nuke miniaturization iwll be examined
...
\todo{'rhetorical analysis methodology'}
C. Analysis of government statements/press releases/proceedings oftalks
This section will look at what negotiating parties have demanded, what's actually come out of negotiations, and how governments talk about one another
...
D. How will conclusions be drawn?
Historical analysis forms the backbone, sets up timeline for rise nad fall of relations
Other two analyses use this as jumping-off point - as diplo changes, hjow has material capacity and rhetoric shifted?
Are there patterns? things we can use to inform likely actions in future shifting relations?
