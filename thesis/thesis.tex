...
-rich 14 examined 15 years of data \& looked at mentions correlating with nuclear stuff

-looked at the 6pt: member nations one would expect to see lots of mentions re: nuclear, given that's the major nuclear negotiation locus

-US not mentioned very frequently - near the middle in terms of daily references, near the bottom in terms of references overall

-however, stronger correlation with nuclear than any other 6pt country

-correlating with earlier research (rich 12) which found "An increase in references to the United States, holding all else constant, is the largest predictor of additional references to nuclear issues."

-this suggests that US is disproportionately held relevant to DPRK nuclear concerns - even tho conversations are arguably multilat, DPRK believes US is driving the bus/cares the most about US actions in the talks \& out of them
