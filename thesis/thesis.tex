...
Cycle 1 and before: HW bush's sr officials didn't believe in prospect of diplomatic solution; through 1993 US avoided talks, avoided negotiating once in them, and didn't follow through on the things they DID agree to. Also, "no negotiations until you comply" approach (which softened afterwards but is now again US default (cite "precondition for negotiation" thing)) made it difficult to figure out how to bring DPRK into compliance when not in it

End of cycle 2: Carter's visit to DPRK was dramatic shift in US diplomatic strategy - he explicitly said no to US sanction and yes to talking - this made people mad until it worked

Late 90s: perry and armitage reports come out, both suggesting "package deal"/"integrated" negotiations (read one or both to figure out what this means!) which departed from previous hard-liner plans SOMEHOW
HOWEVER, republicans in congress were more and more hype about being hard-line and this was a thing for both late Clinton and early Bush - encouraged MORe preconditions to negotiation and MORE aggressive sanction regimes

Early bush years: state department receptive to DPRK overtures (armitage), DoD much less so (rumsfeld) - new report emphasizes "take it or leave it" approach; Wolfowitz emphasizes "they hate us" in defense appropriations hearings

Axis of Evil speech - combined with DoD nuke policy leak + Rumsfeld pushing preemptive strike language - a VERY BAD TIME FOR FRIENDSHIP

Cycle 4: Kelly visit emblematic of hostility during bush years

\todo{See if there's anything written recently about anything later than 2002...}

\todo{cyclic US rhetoric - cites from txt file \& make not a list}
