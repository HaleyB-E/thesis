...
-this section is going to focus on diplomacy and use the obvious breakpoint: administrative matchups
	-il+clinton --> 1994 AF
	-il+bush --> collapse of AF
	-il+obama
	-un+obama --> leap day + collapse

\subsection{i+c, 1993-2000}
	-general tone of negotiations
		-US: not FRIENDLY but definitely better than pre-clinton stuff
		-DPRK: ??? desperate? econ doing badly? RESEARCH
	-AF
		-why did it work?
		-econ?
		-more than just that?
\subsection{i+b, 2001-2008}
	-general tone of negotiations
		-"tit-for-tat noncompliance"
		-dramatic shift in US policy thanks to bush admin, though was somewhat fractious
		-DPRK:??? research
	-AF
		-collapse
		-why? mostly bush's fault
\subsection{i+o, 2009-2011}
	-general tone of negotiations
		-do more research on this - "strategic patience", maybe, but ????
		-DPRK trying to pave way for successor
		-obama trying to shift paradigm
	-did anything super notable happen here? nuclear test, cheonon/yeonpyeong
\subsection{u+o, 2012 and beyond}
	-general tone of negotiations
		-????
	-leap day agreement
		-eventual collapse
