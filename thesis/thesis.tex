...
The death of Kim Il-sung meant that Kim Jong-il took power in the midst of a crisis, facing highly credible American threats of both economic sanctions and military power \cite{cerami}. Simultaneously, the still-new Clinton administration feared the prospect of another war on the Korean peninsula \cite{cumings}. Both sides turned to diplomacy with hitherto-unseen sincerity \cite{sigal}, and aversion of the crisis signaled the rise of a new, more negotiation-centric perspective for American officials.

-let's talk about the AF here - why did it work?

-cycle 6: DPRK tested rockets, international community angry, beginning of disagreements over AF interpretations but eventually sanction relief/missile moratorium agreed to \cite{davenport}
	-DPRK willing to come to negotiation table despite misgivings re: 

-late 90s: several US officials publish reports suggesting "integrated approach" - \cite{perry,armitage}
	-simultaneously, pressure to not Negotiate With The Enemy intensified \cite{harnisch}
	

-cycle 2: crisis had many inputs
	-escalation: US military threat; IAEA inspections (US thought DPRK obfusticating, DPRK thought US manipulating)
	
	new leadership:
		-clinton inherited wargames and coercive diplo
		-kji took power in midst of events and unhappy especially over wargames, previous cancellation of which had been used to cement his legitimacy as militarily mighty heir (farrell)
	
	US perspective:
		-war was scary \& very real prospect (sigal, cumings, maybe others?)
		-war ultimately might not actually solve prolif (cite: someone who said "we can't bomb things we don't know about" but I don't remember who. sigal?)
		-people REALLY don't want to negotiate with north korea - still used to coercive "diplomacy"
	
	DPRK perspective:
		-US controlling international regime to punish them for self-defense - IAEA not really objective entity
		-military threat does bad things for heir apparent and subsequent supreme leader
		-simultaneously, economy is terrible (sigal?) and trying to open up some to combat, but threat of sanctions is concerning
		-new leader wants things to go well under new leadership
	
	Then, incentives combined to produce a climate in which productive diplomacy was possible
		-US not into it at first, but Carter went in and it worked
		-international coercion with sanctions helped, but probably not a primary cause
			-change in government paradigms and both sides' strong interest in coming out without war overwhelmed
			-validated by: DPRK rhetoric leaning heavily US focused, actual negotiations involved US holding international sanction stick w/o directly involving other countries
After the AF:
	...
	-late in administration, Perry and Armitage reports suggest shifting strategy towards "integrated" something
		-but on the other hand, congressional republicans weren't even happy at CURRENT levels and pushed for more hard-line approach - begin to see issues that show up in Bush admin
